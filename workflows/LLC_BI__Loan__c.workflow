...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <recipients>
            <recipient>erik.sinnard@ncino.aremo2</recipient>
            <type>user</type>
        </recipients>
    ...
    <fieldUpdates>
        <fullName>Loan_Default_App_Collection</fullName>
        <description>Loan-Default App-Collection</description>
        <field>LLC_BI__Default_App__c</field>
        <formula>&quot;loancollections.dashboard-loan&quot;</formula>
        <name>Loan-Default App-Collection</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Loan_Stage_Analysis</fullName>
        <description>Loan - Stage = Analysis</description>
        <field>LLC_BI__Stage__c</field>
        <literalValue>Analytics</literalValue>
        <name>Loan - Stage = Analysis</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Loan_Stage_EW_Analysis_Complete</fullName>
        <description>Loan - Stage = EW Analysis Complete</description>
        <field>LLC_BI__Stage__c</field>
        <literalValue>External Collections</literalValue>
        <name>Loan - Stage = EW Analysis Complete</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Loan_Stage_Enhanced_Monitoring</fullName>
        <description>Loan - Stage = Enhanced Monitoring</description>
        <field>LLC_BI__Stage__c</field>
        <literalValue>Internal Collections</literalValue>
        <name>Loan - Stage = Enhanced Monitoring</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
...
Relationship Name - Product Type - Product</description>
    ...
    <fieldUpdates>
        ...
        <field>LLC_BI__Default_App__c</field>
        <formula>&quot;apac-res-mtg-defaultui.apac-loandetail-mortgage&quot;</formula>
    ...
    <fieldUpdates>
        <fullName>Update_Default_App2</fullName>
        <field>LLC_BI__Default_App__c</field>
        <formula>&apos;heloc-loan-grp1.heloc-loan-detail&apos;</formula>
    ...
    <fieldUpdates>
        <fullName>Update_Default_App3</fullName>
        <field>LLC_BI__Default_App__c</field>
        <formula>&apos;heloc-loan-grp1.heloc-loan-detail&apos;</formula>
        <name>Update Default App</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>Update_Default_App4</fullName>
        <field>LLC_BI__Default_App__c</field>
        <formula>&apos;veh-loan-grp1.veh-loan-detail&apos;</formula>
        <name>Update Default App</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    ...
    <fieldUpdates>
        <fullName>Update_Default_App5</fullName>
        <field>LLC_BI__Default_App__c</field>
        <formula>&apos;veh-loan-grp1.veh-loan-detail&apos;</formula>
        <name>Update Default App</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>Update_Default_App6</fullName>
        <field>LLC_BI__Default_App__c</field>
        <formula>&apos;loc1.loc-loan-detail&apos;</formula>
        <name>Update Default App</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    ...
    <fieldUpdates>
        <fullName>Update_Default_App7</fullName>
        <field>LLC_BI__Default_App__c</field>
        <formula>&apos;term1.term-loan-detail&apos;</formula>
        <name>Update Default App</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    ...
    <fieldUpdates>
        <fullName>Update_Projected_Close_Date</fullName>
        <field>LLC_BI__CloseDate__c</field>
        <formula>(Today() + 3)</formula>
        <name>Update Projected Close Date</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Update_Record_Type_to_Retail</fullName>
        <description>Updates the Record Type</description>
        <field>RecordTypeId</field>
        <lookupValue>Loan_Consumer</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>Update Record Type to Retail</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <fieldUpdates>
        ...
        <description>Record type collection</description>
        <field>RecordTypeId</field>
        <lookupValue>Loan_Collections</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <rules>
        <fullName>LTV is below 65%25</fullName>
        <actions>
            <name>LTV_has_dropped_below_65</name>
            <type>Task</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>LLC_BI__Loan__c.LTV__c</field>
        ...
        <description>Creates tasks when the loan LTV drops below 65% DMR - 000321.</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Loan - Update Default App - Collection</fullName>
        <actions>
            <name>Loan_Default_App_Collection</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
        ...
        <criteriaItems>
            <field>LLC_BI__Loan__c.Move_to_Collections__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <description>Update default app to loancollection</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Loan transitioned to Enhanced Monitoring</fullName>
        <actions>
            <name>Covenant_Breach_Notice</name>
            <type>Task</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>LLC_BI__Loan__c.LLC_BI__Stage__c</field>
            <operation>equals</operation>
            <value>Internal Collections</value>
        </criteriaItems>
        <description>Loan transitioned to Enhanced Monitoring. Used in Collection/ILM Journey</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Update Default App to Display Application Group for Consumer HELOAN</fullName>
        <actions>
            <name>Update_Default_App3</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>LLC_BI__Loan__c.LLC_BI__Product_Type__c</field>
            <operation>equals</operation>
            <value>Consumer - Home Equity Term Loan</value>
        </criteriaItems>
        <description>Fire on loan creation. Updates the default app to the HELOAN</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Update Default App to Display Application Group for Consumer HELOC</fullName>
        <actions>
            <name>Update_Default_App2</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>LLC_BI__Loan__c.LLC_BI__Product_Type__c</field>
            <operation>equals</operation>
            <value>Consumer - HELOC</value>
        </criteriaItems>
        <description>Fire on loan creation. Updates the default app to the HELOC</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Update Default App to Display Application Group for Consumer Home Equity Term Loan</fullName>
        <active>false</active>
        <criteriaItems>
            <field>LLC_BI__Loan__c.LLC_BI__Product_Line__c</field>
            <operation>equals</operation>
    ...
    <rules>
        <fullName>Update Default App to Display Application Group for Consumer Recreational Vehicle</fullName>
        <actions>
            <name>Update_Default_App4</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>LLC_BI__Loan__c.LLC_BI__Product_Type__c</field>
            <operation>equals</operation>
            <value>Consumer - Recreational Vehicle</value>
        </criteriaItems>
        <description>Fire on loan creation. Updates the default app to the Recreational Vehicle</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Update Default App to Display Application Group for Consumer Unsecured LOC</fullName>
        <actions>
            <name>Update_Default_App6</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>LLC_BI__Loan__c.LLC_BI__Product_Type__c</field>
            <operation>equals</operation>
            <value>Consumer - Unsecured LOC</value>
        </criteriaItems>
        <description>Fire on loan creation. Updates the default app to the Consumer Unsecured LOC</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Update Default App to Display Application Group for Consumer Unsecured Term</fullName>
        <actions>
            <name>Update_Default_App7</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>LLC_BI__Loan__c.LLC_BI__Product_Type__c</field>
            <operation>equals</operation>
            <value>Consumer - Unsecured Term</value>
        </criteriaItems>
        <description>Fire on loan creation. Updates the default app to the Consumer Unsecured Term</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Update Default App to Display Application Group for Consumer Vehicle</fullName>
        <actions>
            <name>Update_Default_App5</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>LLC_BI__Loan__c.LLC_BI__Product_Type__c</field>
            <operation>equals</operation>
            <value>Consumer - Vehicle</value>
        </criteriaItems>
        <description>Fire on loan creation. Updates the default app to the Consumer Vehicle</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Update Projected Close Date</fullName>
        <actions>
            <name>Update_Projected_Close_Date</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>Update Record Type to Consumer</fullName>
        <actions>
            <name>Update_Record_Type_to_Retail</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <description>Updates the record type to Loan - Consumer when Consumer Product Line is selected</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <tasks>
    ...
    <tasks>
        <fullName>Covenant_Breach_Notice</fullName>
        <assignedTo>erik.sinnard@ncino.aremo2</assignedTo>
        <assignedToType>user</assignedToType>
        <description>Covenant has been breached. Please review all loans assigned to this Relationship.</description>
        <dueDateOffset>0</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        <priority>Normal</priority>
        <protected>false</protected>
        <status>Not Started</status>
        <subject>Covenant Breach Notice</subject>
    </tasks>
    <tasks>
    ...
    <tasks>
        <fullName>LTV_has_dropped_below_65</fullName>
        <assignedTo>erik.sinnard@ncino.aremo2</assignedTo>
        <assignedToType>user</assignedToType>
        <dueDateOffset>0</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        ...
        <protected>false</protected>
        <status>Not Started</status>
        <subject>LTV has dropped below 65%</subject>
    </tasks>
    <tasks>
        <fullName>Loan_Analysis_has_been_approved</fullName>
        <assignedTo>erik.sinnard@ncino.aremo2</assignedTo>
        <assignedToType>user</assignedToType>
        <description>Loan Analysis has been approved</description>
        <dueDateOffset>0</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        <priority>Normal</priority>
        <protected>false</protected>
        <status>Not Started</status>
        <subject>Loan Analysis has been approved</subject>
    </tasks>
    <tasks>
        <fullName>Loan_Approval_Request</fullName>
        <assignedTo>erik.sinnard@ncino.aremo2</assignedTo>
        <assignedToType>user</assignedToType>
        <description>Please review this loan. Covenant is breached.</description>
        <dueDateOffset>0</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        <priority>Normal</priority>
        <protected>false</protected>
        <status>Not Started</status>
        <subject>Loan Approval Request</subject>
    </tasks>
    <tasks>
