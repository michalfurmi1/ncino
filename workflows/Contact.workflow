...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Update_Approved_Broker_Status</fullName>
        <field>Broker_Status__c</field>
        <literalValue>Certified Broker</literalValue>
        <name>Update Approved Broker Status</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Update_Record_Type_Broker</fullName>
        <description>This is used in the default record type workflow rule for setting type for brokers.</description>
        <field>RecordTypeId</field>
        <lookupValue>Broker</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>Update Record Type = Broker</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <rules>
        <fullName>Broker Record Type Setting</fullName>
        <actions>
            <name>Update_Record_Type_Broker</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <description>This will set the record type to broker based on selection!</description>
